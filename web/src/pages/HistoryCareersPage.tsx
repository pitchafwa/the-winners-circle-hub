    ...
    <section className="section">
      <div className="section-head">
        ...
        <span className="label">
          every season on record, 2012–present
          <ScreenshotButton targetRef={tableRef} filename="franchise-careers" />
        </span>
      </div>
      {all.bundles.length > 0 && <CareerTable ref={tableRef} bundles={all.bundles} badges={badges.data} />}
